...
/*   Updated: 2022/03/28 17:19:15 by hseong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	if (fdf_load_map(argc, argv, &map_info) == FALSE)
	{
	...
	if (init_win(&mlx_info) != 0 || init_img(&mlx_info, &img_elem) != 0)
	{
