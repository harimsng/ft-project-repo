...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_PERCENT = 7,              /* "%"  */
  YYSYMBOL_TOKEN_NUMBER = 8,               /* "number"  */
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, SExpression **expression, yyscan_t scanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (expression);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, SExpression **expression, yyscan_t scanner)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, expression, scanner);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, SExpression **expression, yyscan_t scanner)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], expression, scanner);
      YYFPRINTF (stderr, "\n");
    }
}
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, SExpression **expression, yyscan_t scanner)
{
  YY_USE (yyvaluep);
  YY_USE (expression);
  YY_USE (scanner);
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, expression, scanner);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, expression, scanner);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
